      ...
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8 bg-[#292a2d] text-white relative">
          ...
          {messages.length === 0 ? (
            ...
            <p className="text-sm mt-2">Assalamualaikum!! How can I help you today?</p>
            </>
          ):
          (
        ...
        <p className="text-xs absolute bottom-1 text-gray-500">Power By 10 Creative Solution SDN.BHD</p>
